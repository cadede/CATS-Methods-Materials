function [T,pT,newspeed,newhead,GPSI] = gtrack(pitch, head, p, fs,speed,tagon,DN,GPS,GPSerr,errThresh,adjspeed,excludeloops,method)
%%
...
if nargin<12 || isempty(excludeloops)  % an attempt to exclude bubble nets from adjustment (leave circles as the pseudo tracks).  Mixed success
    excludeloops = false;
end
