function [vidDN, vidDurs] = makeMovieTimes(dur,timestamps,simpleread,folder,ripAudio,timewarn,whaleID,vidNums,audioonly,ignorebadaudio)
dbstop if error;
...
titl = 'select FIRST movie (or audio) file from deployment';
