...
vidDurs(movN(mlast-m1+1)+1:end) = []; frameTimes(movN( mlast-m1+1)+1:end) = []; vidDN(movN( mlast-m1+1)+1:end) = []; vidNam(movN( mlast-m1+1)+1:end) = []; try oframeTimes(movN( mlast-m1+1)+1:end) = []; catch; end
vid4k = true;
