...
if Ne~=9; time = 0; flag = true; return; end
flag = false;
for n=1:Ne
    [r,c] = find(L==n);
    if sum(length(r),length(c))<9; flag = true; time = 0; return; end % if there's just a little piece, you're probably not getting the whole number
    % Extract letter
